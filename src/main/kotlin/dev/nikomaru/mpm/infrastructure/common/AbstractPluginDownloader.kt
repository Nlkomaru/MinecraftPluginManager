...
package dev.nikomaru.mpm.infrastructure.common

import dev.nikomaru.mpm.domain.model.repository.PluginDownloader
...
abstract class AbstractPluginDownloader : PluginDownloader {
     ...
     * @return ダウンロードしたファイル
     */
    protected suspend fun downloadFile(downloadUrl: String, fileName: String): File? {
        return withContext(Dispatchers.IO) {
            try {
                val fileResponse = httpClient.get(downloadUrl) {
                    headers {
     ...
     * @return レスポンスの本文
     */
    protected suspend fun getRequest(url: String, acceptHeader: String): String {
        return withContext(Dispatchers.IO) {
